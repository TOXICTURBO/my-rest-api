    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to TurboApis - Made By TurboMods!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=916380260672">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>TurboMods</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"TurboMods" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - TurboApis`,
        html: inboxGmail,
      };
